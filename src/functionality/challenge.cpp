...
// Constructor implementation for a completed challenge
Challenge::Challenge(const String &id, const String &game, bool played, const String &player1Name, int player1Score, const String &player2Name, int player2Score, const String &winner)
        : m_ID(id), m_game(game), m_played(played), m_player1Name(player1Name), m_player1Score(player1Score),
          m_player2Name(player2Name), m_player2Score(player2Score), m_winner(winner)
{
    m_challengeSummery = game + " - " + m_player1Name;
}
